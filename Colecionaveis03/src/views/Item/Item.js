...
function Item({ navigation, route }) {
    ...
    const {operacao, setOperacao} = route.params; // esse só carrega se o usuário clicar na operação

    useEffect(() => { // dado executado antes da disponibilização para o usuário
